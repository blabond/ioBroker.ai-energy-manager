  ...
  return [...keys].map((key) => {
    ...
    return {
      ...
      featureLabel:
        ...
        "",
      read:
        serverDefinition.read !== undefined
          ? !!serverDefinition.read
          : localDefinition.read !== false,
      write:
        serverDefinition.write !== undefined
          ? !!serverDefinition.write
          : localDefinition.write === true,
      required:
