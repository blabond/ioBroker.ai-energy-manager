...
const FEATURES = {
    battery: {
        ...
        datapoints: ['batterySoc', 'batteryPower', 'batteryControlMode', 'batteryMode', 'batteryReserveSoc'],
    },
    gridMeter: {
        label: 'Grid meter',
    ...
    pvForecast: {
        label: 'PV forecast',
        datapoints: ['pvForecast', 'pvPower', 'pvDailyYield'],
    },
    storageSystem: {
        label: 'Storage system',
        datapoints: ['storageSystemSoc', 'storageSystemBatteryPower', 'storageSystemPvPower', 'storageSystemMode'],
    },
    energyMeter: {
        label: 'Energy meter',
