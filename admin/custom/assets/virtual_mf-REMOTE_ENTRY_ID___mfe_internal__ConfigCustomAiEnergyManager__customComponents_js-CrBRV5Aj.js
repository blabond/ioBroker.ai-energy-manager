...
var t = `FEDERATION_DEBUG`,
  n = { AT: `@`, HYPHEN: `-`, SLASH: `/` },
  r = { [n.AT]: `scope_`, [n.HYPHEN]: `_`, [n.SLASH]: `__` };
(r[n.AT], n.AT, r[n.HYPHEN], n.HYPHEN, r[n.SLASH], n.SLASH);
var i = (function (e) {
  return (
    (e[(e.UNKNOWN = 1)] = `UNKNOWN`),
    (e[(e.CALCULATED = 2)] = `CALCULATED`),
    (e[(e.NO_USE = 0)] = `NO_USE`),
    e
  );
})({});
...
function o() {
  ...
  return (
    typeof navigator < `u` &&
    ((e = navigator) == null ? void 0 : e.product) === `ReactNative`
  );
}
function s() {
  try {
...
function c() {
  return typeof process < `u` && {}.FEDERATION_DEBUG
    ? !!{}.FEDERATION_DEBUG
    : typeof FEDERATION_DEBUG < `u` && FEDERATION_DEBUG
      ? !0
      : s();
}
var l = `[ Federation Runtime ]`,
  u = function (...e) {
    return e.length
      ? e.reduce((e, t) => (t ? (e ? `${e}:${t}` : t) : e), ``)
      : ``;
  },
  d = (e, t) => {
    if (`getPublicPath` in e) {
      let n;
      return (
        (n = e.getPublicPath.startsWith(`function`)
          ? Function(`return ` + e.getPublicPath)()()
          : Function(e.getPublicPath)()),
        `${n}${t}`
      );
    } else if (`publicPath` in e)
      return !a() &&
        !o() &&
        `ssrPublicPath` in e &&
        typeof e.ssrPublicPath == `string`
        ? `${e.ssrPublicPath}${t}`
        : `${e.publicPath}${t}`;
    else
      return (
...
function ee(e, t = {}) {
  var n;
  let { remotes: r = {}, overrides: i = {}, version: a } = t,
    o,
    s = () =>
      `publicPath` in e.metaData
        ? (e.metaData.publicPath === `auto` || e.metaData.publicPath === ``) &&
          a
          ? h(a)
  ...
  (Object.keys(r).length ||
    (l =
      ((n = e.remotes) == null
        ...
        : n.reduce((e, t) => {
            let n,
              r = t.federationContainerName;
            return (
              (n = c.includes(r) ? i[r] : `version` in t ? t.version : t.entry),
              (e[r] = { matchedVersion: n }),
              e
            );
          }, {})) || {}),
    Object.keys(r).forEach(
      (e) => (l[e] = { matchedVersion: c.includes(e) ? i[e] : r[e] }),
    ));
  let {
      remoteEntry: { path: u, name: d, type: f },
      types: p = { path: ``, name: ``, zip: ``, api: `` },
      buildInfo: { buildVersion: ee },
      globalName: te,
      ssrRemoteEntry: g,
    } = e.metaData,
    { exposes: _ } = e,
  ...
  if (
    (`publicPath` in e.metaData
      ? ((o = { ...ne, publicPath: s() }),
        typeof e.metaData.ssrPublicPath == `string` &&
          (o.ssrPublicPath = e.metaData.ssrPublicPath))
      : (o = { ...ne, getPublicPath: s() }),
    g)
  ) {
    let e = m(g.path, g.name);
    ((o.ssrRemoteEntry = e),
      (o.ssrRemoteEntryType = g.type || `commonjs-module`));
  }
  return o;
}
function te(e) {
...
function ce(e, t) {
  let n = /^(https?:)?\/\//i;
  return (
    e.replace(n, ``).replace(/\/$/, ``) === t.replace(n, ``).replace(/\/$/, ``)
  );
}
function le(e) {
  let t = null,
  ...
  if (!t) {
    ...
    let i;
    (e.createScriptHook &&
      ((i = e.createScriptHook(e.url, e.attrs)),
      i instanceof HTMLScriptElement
        ? (t = i)
        : typeof i == `object` &&
          (`script` in i && i.script && (t = i.script),
          `timeout` in i && i.timeout && (r = i.timeout))),
      (t.src ||= e.url),
      n &&
        !i &&
        Object.keys(n).forEach((e) => {
          t &&
            (e === `async` || e === `defer`
              ? (t[e] = n[e])
              : t.getAttribute(e) || t.setAttribute(e, n[e]));
        }));
  }
  let o = null,
    s =
      typeof window < `u`
        ? (t) => {
            if (t.filename && ce(t.filename, e.url)) {
              let n = Error(
                `ScriptExecutionError: Script "${e.url}" loaded but threw a runtime error during execution: ${t.message} (${t.filename}:${t.lineno}:${t.colno})`,
              );
  ...
  let c = async (n, r) => {
    ...
    let a = () => {
      if ((r == null ? void 0 : r.type) === `error`) {
        let t = Error(
          r != null && r.isTimeout
            ? `ScriptNetworkError: Script "${e.url}" timed out.`
            : `ScriptNetworkError: Failed to load script "${e.url}" - the script URL is unreachable or the server returned an error (network failure, 404, CORS, etc.)`,
        );
        ((t.name = `ScriptNetworkError`),
          e != null &&
            e.onErrorCallback &&
            (e == null || e.onErrorCallback(t)));
      } else
        o
          ? e != null &&
            e.onErrorCallback &&
            (e == null || e.onErrorCallback(o))
    ...
    if (
      ...
      se(() => {
        ...
        n && t != null && t.parentNode && t.parentNode.removeChild(t);
      }),
      n && typeof n == `function`)
    ) {
      let e = n(r);
  ...
  return (
    (t.onerror = c.bind(null, t.onerror)),
    (t.onload = c.bind(null, t.onload)),
    (i = setTimeout(() => {
      c(null, { type: `error`, isTimeout: !0 });
    }, r)),
    { script: t, needAttach: n }
  );
}
function ue(e) {
  let t = null,
  ...
  let i = (n, r) => {
    let i = () => {
      (r == null ? void 0 : r.type) === `error`
        ? e != null && e.onErrorCallback && (e == null || e.onErrorCallback(r))
        : e != null && e.cb && (e == null || e.cb());
    };
    if (
      t &&
...
var fe = (e) =>
  ...
  pe = (e, t, n, r) => {
    let i = [`${[t[e]]} #${e}`];
    return (
      n && i.push(`args: ${JSON.stringify(n)}`),
      i.push(fe(e)),
      r && i.push(`Original Error Message:\n ${r}`),
      i.join(`
`)
    );
  };
...
function b(e, t, n, r, i) {
  ...
  throw a instanceof Error
    ? (a.message.startsWith(v) || (a.message = `${v}: ${a.message}`), a)
    : Error(`${v}: ${a}`);
}
function ge(e) {
  (e instanceof Error &&
    (e.message.startsWith(v) || (e.message = `${v}: ${e.message}`)),
    he.warn(e));
}
function _e(e, t) {
...
var Te = (e, t) => {
  ...
  S = typeof globalThis == `object` ? globalThis : window,
  C = (() => {
    try {
          ...
          : M(n)
            ...
            : M(r)
              ...
              : i
                ? t === `0`
                  ? n === `0`
                    ? `>=${t}.${n}.${r}-${i} <${t}.${n}.${Number(r) + 1}-0`
                    : `>=${t}.${n}.${r}-${i} <${t}.${Number(n) + 1}.0-0`
                  : `>=${t}.${n}.${r}-${i} <${Number(t) + 1}.0.0-0`
                : t === `0`
                  ? n === `0`
                    ? `>=${t}.${n}.${r} <${t}.${n}.${Number(r) + 1}-0`
                    : `>=${t}.${n}.${r} <${t}.${Number(n) + 1}.0-0`
                  : `>=${t}.${n}.${r} <${Number(t) + 1}.0.0-0`,
      ),
    )
    .join(` `);
}
            ...
            : t && c
              ? (s && (r = 0),
                ...
                t === `>`
                  ? ((t = `>=`),
                    s
                      ? ((n = Number(n) + 1), (r = 0), (i = 0))
                      : ((r = Number(r) + 1), (i = 0)))
                  : t === `<=` &&
                    ((t = `<`), s ? (n = Number(n) + 1) : (r = Number(r) + 1)),
                t === `<` && (a = `-0`),
                `${t + n}.${r}.${i}${a}`)
              : s
                ? `>=${n}.0.0${a} <${Number(n) + 1}.0.0-0`
                : c
                  ? `>=${n}.${r}.0${a} <${n}.${Number(r) + 1}.0-0`
                  : e
        );
      }),
    )
      ...
      `get` in e
        ...
        : `lib` in e
          ...
          : () =>
              Promise.resolve(() => {
                b(
                  `Cannot get shared "${n}" from "${t}": neither "get" nor "lib" is provided in the share config.`,
                );
              })),
    (a = e.shareConfig) != null &&
      a.eager &&
      (o = e.treeShaking) != null &&
      o.mode &&
      b(
        `Invalid shared config for "${n}" from "${t}": cannot use both "eager: true" and "treeShaking.mode" simultaneously. Choose one strategy.`,
      ),
    {
      deps: [],
      useIn: [],
      ...
      strategy: (e.strategy ?? r) || `version-first`,
      treeShaking: e.treeShaking
        ? {
            ...e.treeShaking,
            mode: e.treeShaking.mode ?? `server-calc`,
            status: e.treeShaking.status ?? i.UNKNOWN,
            useIn: [],
          }
        : void 0,
    }
...
function It(e, t) {
  for (let n of e) {
    ...
    if (e) {
      if (r.startsWith(`/`)) {
        let e = n.name;
        return ((r = `.${r}`), { pkgNameOrAlias: e, expose: r, remote: n });
      } else if (r === ``)
        return { pkgNameOrAlias: n.name, expose: `.`, remote: n };
    }
    let i = n.alias && t.startsWith(n.alias),
      a = n.alias && t.replace(n.alias, ``);
    if (n.alias && i) {
      if (a && a.startsWith(`/`)) {
        let e = n.alias;
        return ((a = `.${a}`), { pkgNameOrAlias: e, expose: a, remote: n });
      } else if (a === ``)
...
async function nn({ entry: t, remoteEntryExports: n }) {
  return new Promise((r, i) => {
    try {
      ...
      b(
        `Failed to load ESM entry from "${t}". ${e instanceof Error ? e.message : String(e)}`,
      );
    }
  });
}
...
async function on({
  ...
  return de(s, {
    ...
    createScriptHook: (e, t) => {
      ...
      if (
        n &&
        (n instanceof HTMLScriptElement || `script` in n || `timeout` in n)
      )
        return n;
    },
  }).then(
  ...
  if (!T[o]) {
    ...
    T[o] = e
      ...
      .catch(async (e) => {
        ...
        if (
          e instanceof Error &&
          e.message.includes(`RUNTIME-008`) &&
          !o &&
          !a
        ) {
...
function dn(e, t) {
  ...
  return (
    n.length > 0 &&
      n.forEach((t) => {
        e != null && e.find((e) => e.name !== t.name) && e.push(t);
      }),
    e &&
      e.length > 0 &&
      e.forEach((e) => {
...
function q(e) {
  ...
  for (let [t, n] of Object.entries(e.shared)) {
    ...
    e &&
      (r[t] = {
        version: e.version,
        singleton: (i = e.shareConfig) == null ? void 0 : i.singleton,
        requiredVersion:
          ((a = e.shareConfig) == null ? void 0 : a.requiredVersion) === !1
            ? !1
            : (o = e.shareConfig) == null
              ? void 0
              : o.requiredVersion,
        eager: e.eager,
        strictVersion: (s = e.shareConfig) == null ? void 0 : s.strictVersion,
      });
  }
  return {
    project: {
      name: e.name,
      mfRole:
        ((t = e.remotes) == null ? void 0 : t.length) > 0 ? `host` : `unknown`,
    },
    mfConfig: {
      name: e.name,
...
function gn(e, t, n, r = !0) {
  ...
  if (t.options.inBrowser) {
    if (
      (o.forEach((n) => {
        ...
        ln(
          i
            ...
            : { origin: t, remoteInfo: r, remoteEntryExports: void 0 },
        );
      }),
      r)
    ) {
      let n = { rel: `preload`, as: `style` };
      i.forEach((r) => {
      ...
      let n = { rel: `stylesheet`, type: `text/css` };
      i.forEach((r) => {
        let { link: i, needAttach: a } = ue({
          url: r,
          cb: () => {},
...
function _n(e, t, n) {
  ...
  return (
    Object.defineProperty(a, `shareScopeMap`, { value: r, enumerable: !1 }),
...
var vn = class {
    ...
    async get(e, t, n, r) {
      let { loadFactory: i = !0 } = n || { loadFactory: !0 },
        a = await this.init(e, r);
      this.lib = a;
      let o;
      ((o = await this.host.loaderHook.lifecycle.getModuleFactory.emit({
        ...
        (o ||= await a.get(t)),
        y(o, `${x(this.remoteInfo)} remote don't export ${t}.`));
      let s = Te(this.remoteInfo.name, t),
        c = this.wraperFactory(o, s);
      return i ? await c() : c;
    }
    wraperFactory(e, t) {
      function n(e, t) {
        ...
        let r = 0,
          i = (t) =>
            t === !1
              ? !1
              : r < n.length
                ? Promise.resolve(n[r++].apply(null, e)).then(i)
                : t;
        t = i();
      }
...
var X = class extends J {
    ...
    emit(e) {
      be(e) || b(`The data for the "${this.type}" hook should be an object.`);
  ...
  Z = class extends J {
    ...
    emit(e) {
      be(e) ||
        b(`The response data for the "${this.type}" hook must be an object.`);
  ...
  Q = class {
    ...
    applyPlugin(e, t) {
      y(Se(e), `Plugin configuration is invalid.`);
      let n = e.name;
      if (
        (y(n, `A name must be provided by the plugin.`),
        !this.registerPlugins[n])
      ) {
        var r;
        ((this.registerPlugins[n] = e),
          (r = e.apply) == null || r.call(e, t),
    ...
    removePlugin(e) {
      ...
      (y(t, `The plugin "${e}" is not registered.`),
...
function xn() {
  return {
    ...
    async afterResolve(e) {
      ...
      if (!ve(t) || !ye(t)) {
        let { remoteSnapshot: s, globalSnapshot: c } =
...
function Tn(e, t, n, r, i) {
  ...
  if (
    (Cn(
      ...
      (t, n, r) => {
        ...
        m.length &&
          `modules` in t &&
          (u =
            t == null || (i = t.modules) == null
              ? void 0
              : i.reduce(
                  (e, t) => (
                    (m == null ? void 0 : m.indexOf(t.moduleName)) !== -1 &&
                      e.push(t),
                    e
                  ),
                  [],
        ...
        function h(e) {
          let n = e.map((e) => d(t, e));
          return c.filter ? n.filter(c.filter) : n;
        }
        if (u) {
          let r = u.length;
          for (let i = 0; i < r; i++) {
            let r = u[i],
              s = `${n.name}/${r.moduleName}`;
            (e.remoteHandler.hooks.lifecycle.handlePreloadModule.emit({
              id: r.moduleName === `.` ? n.name : s,
              name: n.name,
              remoteSnapshot: t,
              preloadConfig: c,
              remote: n,
    ...
    let t = (t, n) => {
      ...
      r &&
        typeof r.lib == `function` &&
        (n.assets.js.sync.forEach((e) => {
          c.add(e);
        }),
    ...
    i.shared.forEach((e) => {
      var n;
      let r = (n = u.shared) == null ? void 0 : n[e.sharedName];
      if (!r) return;
      let i = e.version ? r.find((t) => t.version === e.version) : r;
      i &&
        Ce(i).forEach((n) => {
          t(n, e);
        });
...
var On = class {
    ...
    async loadRemoteSnapshotInfo({ moduleInfo: e, id: t, expose: n }) {
      ...
      let {
        ...
        { remoteSnapshot: c, globalSnapshot: l } =
    ...
    async getManifestJson(e, t, n) {
      let r = async () => {
          ...
          return (
            y(
              n.metaData && n.exposes && n.shared,
              `"${e}" is not a valid federation manifest for remote "${t.name}". Missing required fields: ${[!n.metaData && `metaData`, !n.exposes && `exposes`, !n.shared && `shared`].filter(Boolean).join(`, `)}.`,
            ),
            this.manifestCache.set(e, n),
            n
          );
        },
        i = async () => {
  ...
  kn = class {
    ...
    registerShared(e, t) {
      ...
      return (
          ...
          n[e].forEach((n) => {
            n.scope.forEach((r) => {
              ...
              (this.hooks.lifecycle.beforeRegisterShare.emit({
                ...
                ((i = this.shareScopeMap[r]) != null && i[e]) ||
                  this.setShared({
                    pkgName: e,
                    lib: n.lib,
                    get: n.get,
        ...
        { newShareInfos: n, allShareInfos: r }
      );
    }
    async loadShare(e, t) {
      let { host: n } = this,
    ...
    initializeSharing(e = I, t) {
      let { host: n } = this,
        ...
        a = t == null ? void 0 : t.initScope,
        o = [];
      if (r !== `build`) {
        let { initTokens: t } = this;
        a ||= [];
        let n = t[e];
        if (((n ||= t[e] = { from: this.host.name }), a.indexOf(n) >= 0))
          return o;
        a.push(n);
      }
        ...
        u = (e, t) => {
          ...
          let a = l[e],
            ...
            s = !!(
              o &&
              ((`eager` in o && o.eager) ||
                (`shareConfig` in o && (n = o.shareConfig) != null && n.eager))
            );
          (!o ||
            (o.strategy !== `loaded-first` &&
              !o.loaded &&
              (!i == !s ? c > a[r].from : i))) &&
            (a[r] = t);
        },
        d = async (e) => {
          let { module: t } = await n.remoteHandler.getRemoteModuleAndOptions({
              id: e,
            }),
            r;
          try {
            ...
            if (
              ((r = await n.remoteHandler.hooks.lifecycle.errorLoadRemote.emit({
                id: e,
                error: t,
                from: `runtime`,
            ...
            r != null &&
              r.init &&
              !t.initing &&
              ((t.remoteEntryExports = r), await t.init(void 0, void 0, a));
          }
        };
      return (
        Object.keys(n.options.shared).forEach((t) => {
    ...
    setShared({
      ...
      let { version: c, scope: l = `default`, ...u } = t,
  ...
  An = class {
    ...
    setIdToRemoteMap(e, t) {
      let { remote: n, expose: r } = t,
        { name: i, alias: a } = n;
      if (
        ((this.idToRemoteMap[e] = { name: n.name, expose: r }),
        a && e.startsWith(i))
      ) {
        let t = e.replace(i, a);
        this.idToRemoteMap[t] = { name: n.name, expose: r };
        return;
      }
      if (a && e.startsWith(a)) {
        let t = e.replace(a, i);
    ...
    async loadRemote(e, t) {
      let { host: n } = this;
      try {
        let { loadFactory: r = !0 } = t || { loadFactory: !0 },
          {
            module: i,
            moduleOptions: a,
            remoteMatchInfo: o,
        ...
        let { from: i = `runtime` } = t || { from: `runtime` },
    ...
    registerRemotes(e, t) {
      let { host: n } = this;
      e.forEach((e) => {
        this.registerRemote(e, n.options.remotes, {
    ...
    registerRemote(e, t, n) {
            ...
            let n = t.find((t) => {
              ...
              return (
                ...
                (t.name.startsWith(e.alias) ||
                  ((n = t.alias) == null ? void 0 : n.startsWith(e.alias)))
              );
            });
            y(
              !n,
              `The alias ${e.alias} of remote ${e.name} is not allowed to be the prefix of ${n && n.name} name or alias`,
            );
          }
          (`entry` in e &&
            typeof window < `u` &&
      ...
      if (!a)
        (i(),
          t.push(e),
          this.hooks.lifecycle.registerRemote.emit({ remote: e, origin: r }));
      else {
        let o = [
    ...
    removeRemote(e) {
      try {
        let { host: n } = this,
          { name: r } = e,
          i = n.options.remotes.findIndex((e) => e.name === r);
        i !== -1 && n.options.remotes.splice(i, 1);
        let a = n.moduleCache.get(e.name);
        if (a) {
          var t;
          let r = a.remoteInfo,
            i = r.entryGlobalName;
          S[i] &&
            ((t = Object.getOwnPropertyDescriptor(S, i)) != null &&
            t.configurable
              ? delete S[i]
              : (S[i] = void 0));
          ...
          if (l) {
            ...
            t &&
              ...
              w.__FEDERATION__.__MANIFEST_LOADING__[t] &&
                delete w.__FEDERATION__.__MANIFEST_LOADING__[t]);
          }
  ...
  Mn = class {
    ...
    formatOptions(e, t) {
      let { allShareInfos: n } = Ot(e, t),
        ...
        a = this.remoteHandler.formatAndRegisterRemote(i, r),
        { allShareInfos: o } = this.sharedHandler.registerShared(i, r),
        s = [...i.plugins];
      r.plugins &&
        r.plugins.forEach((e) => {
...
function Pn(e, t) {
  ...
  return S.__FEDERATION__.__INSTANCES__.find(
    (r) =>
      !!(
        (n && r.options.id === n) ||
        (r.options.name === e && !r.options.version && !t) ||
        (r.options.name === e && t && r.options.version === t)
      ),
  );
}
function Fn(e) {
