...
var le = {
    ...
    batteryControlMode: `Batterie Steuerung`,
    ...
    batteryControlModeHelp: `Schreibbarer Datenpunkt, mit dem der lokale 6-Stunden-Plan die Batterie zwischen Netzladen, PV-Betrieb und Halten umschaltet. Die vom Speicher erwarteten Werte unten frei konfigurieren.`,
    batteryControlGridChargeValue: `Wert Netzladen`,
    batteryControlPvValue: `Wert PV`,
    batteryControlHoldValue: `Wert Halten`,
    batteryControlPermissionHint: `Netzladen erlauben: %s`,
    gridChargingPermission: `Netzladen`,
    powerTypeOrGridCharging: `AC/DC / Netzladen`,
    allow: `Erlauben`,
    deny: `Verbieten`,
    ...
    uiUpdateAvailable: `Ein Update der Adapter-Oberfläche ist verfügbar. Bitte lade die Ansicht neu.`,
    ...
    telemetryDataSend: `Telemetrie-Daten senden`,
    ioBrokerBatteryControl: `ioBroker Batterie steuern`,
  ...
  N = {
    ...
    batteryControlMode: `Battery control mode`,
    ...
    batteryControlModeHelp: `Writable datapoint used by the local 6-hour plan to switch the battery between grid charging, PV operation and hold. Configure the exact values required by your storage system below.`,
    batteryControlGridChargeValue: `Grid charging value`,
    batteryControlPvValue: `PV value`,
    batteryControlHoldValue: `Hold value`,
    batteryControlPermissionHint: `Allow grid charging: %s`,
    gridChargingPermission: `Grid charging`,
    powerTypeOrGridCharging: `AC/DC / grid charging`,
    allow: `Allow`,
    deny: `Deny`,
    ...
    uiUpdateAvailable: `An update of the adapter interface is available. Please reload the view.`,
    ...
    telemetryDataSend: `Send telemetry data`,
    ioBrokerBatteryControl: `ioBroker battery control`,
...
(O.setTranslations(S),
  _e(),
  O.setLanguage(W(window.sysLang || window.systemLang || `en`)));
function U(e, ...t) {
  return O.t(e, ...t);
}
function W(e) {
  ...
  let n = t.slice(0, 2);
  return H.has(t) ? t : H.has(n) ? n : `en`;
}
function _e() {
  O.extendTranslations(ge);
}
function ve(t, r) {
  let [i, a] = n(() =>
    W(
...
var G = {
  ...
  xe = null,
  Se = ``,
  Ce = Ee(import.meta.url),
  we = new URL(`../mf-manifest.json`, import.meta.url);
function q(e) {
...
window.aemStandaloneConfig &&
  ((window.load = (e, t) => {
    ...
    ((K = {
      ...G,
      ...n,
      dashboardLite: n.dashboardLite || xe,
      dashboardLiteLastRequest: n.dashboardLiteLastRequest || Se,
    }),
...
function ke({
  ...
  (e(() => {
    ...
    e(() => {
      ...
      let e = {
        ...G,
        ...(q(m) || {}),
        dashboardLite: P.current.dashboardLite || xe,
        dashboardLiteLastRequest: P.current.dashboardLiteLastRequest || Se,
      };
      ((K = e), (P.current = e), T(e));
    }, [m, C]));
  function R(e, t = !0) {
  ...
  function de() {
    let e = String(w.adapterToken || ``).trim();
    if (!e) return;
    let t = !1,
      n = window.setTimeout(() => {
        t || ((t = !0), k(!1), D(U(`adapterNoResponse`)));
      }, pe);
    (k(!0),
      D(U(`configLoading`)),
      z(`requestConfig`, { source: `admin`, adapterToken: e }, (e) => {
        if (!t) {
          if (((t = !0), window.clearTimeout(n), k(!1), !e || e.ok === !1)) {
            D(it(e));
            return;
          }
          (R((t) => ({
    ...
    function n(t = !1) {
      z(`readDashboardLiteState`, { refresh: t }, (t) => {
        if (e) {
          ...
          (t.dashboardLite &&
            ((xe = t.dashboardLite), (Se = t.dashboardLiteLastRequest || ``)),
            R(
              (e) => ({
                ...e,
            ...
            O(
              t.dashboardLiteLastRequest
                ? U(`autoUpdated`, ut(t.dashboardLiteLastRequest))
  ...
  async function me(e) {
    var t;
    let n =
      ((t = w.datapointAssignments) == null || (t = t[e]) == null
        ? void 0
        : t.stateId) || ``;
    if (i != null && i.sendTo) {
      M(e);
    ...
    try {
      ...
      D((e == null ? void 0 : e.message) || U(`objectSelectionUnavailable`));
    }
  }
  let V = String(w.adapterToken || ``).trim().length > 0,
    he = V && ((x = w.serverConfig) == null ? void 0 : x.valid) === !0,
    H = tt(w.datapointAssignments || []);
  return b(u, {
    theme: L,
    children: [
      s(y, {
        className: `aem-root${C ? ` aem-root-embedded` : ``}`,
        children: s(f, {
          className: `aem-shell`,
          elevation: 0,
          children: b(p, {
            ...
            children: [
              ...
              E === 0
                ...
                : s(je, {
                    assignments: w.datapointAssignments || [],
                    busyConfig: se,
                    hasToken: V,
                    requestConfig: de,
                    requestStatus: ne,
      ...
      i != null && i.sendTo && j !== null
        ? s(oe, {
            columns: [`name`, `type`, `role`, `val`],
            onClose: () => M(null),
            onOk: (e) => {
              (typeof e == `string` && e && B(j, { stateId: e }), M(null));
            },
            selected:
              ((S = w.datapointAssignments) == null || (S = S[j]) == null
                ? void 0
                : S.stateId) || ``,
            socket: i,
            theme: L,
  ...
  return n
    ? t
      ? b(p, {
          spacing: 2,
          children: [
            e && at(e) ? s(m, { severity: `error`, children: e }) : null,
            s(Ne, {
      ...
      : s(m, { severity: `warning`, children: U(`dashboardRequiredMissing`) })
    : s(m, { severity: `warning`, children: U(`settingsTokenMissing`) });
}
function je({
  assignments: t,
  busyConfig: i,
  ...
  let h = r(() => qe(t), [t]),
    _ = r(() => {
      let e = {};
      for (let t of h) e[`group:${t.key}`] = Je(t);
      return e;
    }, [h]),
    [x, S] = n(_);
  e(() => {
    S((e) => {
      let t = {};
      for (let [n, r] of Object.entries(_))
        t[n] = Object.prototype.hasOwnProperty.call(e, n) ? e[n] : r;
      return t;
    });
  }, [_]);
  function C(e) {
    ...
    children: [
      b(J, {
        ...
        children: [
          b(y, {
            ...
            children: [
              s(v, {
                ...
                type: `password`,
                value: u.adapterToken || ``,
                onChange: (e) => d(`adapterToken`, e.target.value),
                autoComplete: `off`,
                fullWidth: !0,
              }),
              s(v, {
                label: U(`lastConfigRequest`),
                value: ut(u.serverConfigLastRequest),
          ...
          c ? s(m, { severity: at(c) ? `error` : `info`, children: c }) : null,
        ],
      }),
      s(Ie, {
        groups: h,
      ...
      s(m, { severity: `info`, children: U(`acDcInfo`) }),
    ],
  });
}
function Me() {
  return s(m, {
    ...
    children: b(y, {
      ...
      children: [
        s(A, { variant: `body2`, children: U(`uiUpdateAvailable`) }),
        s(y, { className: `update-notice-spacer` }),
        s(g, {
          variant: `contained`,
          size: `small`,
          onClick: ct,
          children: U(`reloadNow`),
        }),
      ],
    }),
  });
}
function Ne({ dashboard: e, lastRequest: t }) {
  if (!e) return s(Be, { text: U(`noDashboardData`) });
      ...
      b(J, {
        ...
        titleAction: n
          ? s(A, {
              variant: `caption`,
              color: `text.secondary`,
              children: U(`dashboardDataAsOf`, dt(n)),
            })
          : null,
        children: [
          s(y, {
                ...
                f,
                {
                  ...
                  children: [
                    b(A, {
                      ...
                      children: [
                        Ke(e),
                        e.unit ? b(`span`, { children: [` `, e.unit] }) : null,
                      ],
                    }),
                    s(A, {
                      variant: `caption`,
...
function J({
  ...
  let l = r
    ? s(o, {
        in: i,
        timeout: `auto`,
        children: s(y, { className: `section-collapse-content`, children: e }),
      })
    : e;
  return b(f, {
    className: `section${c ? ` ${c}` : ``}`,
    elevation: 0,
    children: [
      b(y, {
        ...
        children: [
          b(y, {
            ...
            children: [
              r
                ? s(h, {
                    "aria-label": U(i ? `collapseSection` : `expandSection`),
                    className: `section-toggle${i ? ` section-toggle-open` : ``}`,
                    onClick: a,
                    size: `small`,
                    children: s(T, {}),
                  })
                : null,
              s(A, { variant: `subtitle1`, component: `h2`, children: t }),
            ],
          }),
          n ? s(y, { className: `section-title-action`, children: n }) : null,
        ],
      }),
      l,
    ],
...
function Pe({ plan: e }) {
  if (!e.length) return s(Be, { text: U(`noSixHourPlan`) });
  let t = Fe(e.slice(0, V));
  return b(p, {
    spacing: 1.5,
    children: [
      s(y, {
        className: `plan-timeline`,
        "aria-label": U(`sixHourPlan`),
        children: t.map((e) =>
          b(
            y,
            {
              ...
              children: [
                b(y, {
                  className: `plan-hour-header`,
                  children: [
                    s(A, { variant: `caption`, children: e.label }),
                    b(A, {
                      variant: `caption`,
                      color: `text.secondary`,
                      children: [Q(e.plannedEnergyKwh, 2), ` kWh`],
                    }),
                  ],
                }),
                s(y, {
                  className: `plan-hour-slots`,
                  children: e.slots.map((e, t) =>
                    s(
                      c,
                      {
                        title: `${pt(e.from, e.to)} · ${X(e.operatingModeLabel || e.actionLabel || `-`)} · ${X(e.batteryCommand || `-`)} · ${X(e.gridBehavior || `-`)} · ${Q(e.plannedPowerW, 0)} W · ${Q(e.plannedEnergyKwh, 2)} kWh${e.technicalActionLabel ? ` · ${U(`technicalAction`, X(e.technicalActionLabel))}` : ``}${e.reason ? ` · ${X(e.reason)}` : ``}`,
                        children: b(y, {
                          className: `plan-slot mode-border-${ht(e)}`,
                          tabIndex: 0,
                          children: [
                            s(A, {
                              variant: `caption`,
                              color: `text.secondary`,
                              children: pt(e.from, e.to),
                            }),
                            s(A, {
                              variant: `body2`,
      ...
      s(y, {
        ...
        children: me.map(([e, t]) =>
          b(
            `span`,
            { children: [s(`i`, { className: `mode-${e}` }), U(t)] },
            e,
          ),
        ),
      }),
...
function Fe(e) {
  let t = [],
    n = new Map();
  for (let r of e) {
    let e = new Date(r.from || r.slot_start || ``),
      i = Number.isNaN(e.getTime())
        ? `unknown-${t.length}`
        : new Date(
            e.getFullYear(),
            e.getMonth(),
    ...
    if (!n.has(i)) {
      let r = {
        key: i,
        label: Number.isNaN(e.getTime())
          ? `-`
          : `${Z(e)} - ${Z(new Date(e.getTime() + 3600 * 1e3))}`,
        plannedEnergyKwh: 0,
        slots: [],
      };
      (t.push(r), n.set(i, r));
    ...
    let a = n.get(i);
    ((a.plannedEnergyKwh += Number(r.plannedEnergyKwh || 0)), a.slots.push(r));
  }
  return t;
}
function Ie({
  ...
  return e.length
        ...
        children: e.map((e) => {
          ...
          return s(
            J,
            {
              ...
              onToggle: () => r(o),
              title: e.title,
              titleAction: e.subtitle
                ? s(D, { size: `small`, label: e.subtitle })
                : null,
              children: b(p, {
                spacing: 1,
                children: [
                  ...
                  s(k, {
                    children: b(te, {
                      ...
                      children: [
                        b(`colgroup`, {
                          children: [
                            s(`col`, { className: `datapoint-col-label` }),
                            s(`col`, { className: `datapoint-col-type` }),
                            s(`col`, { className: `datapoint-col-unit` }),
                            s(`col`, { className: `datapoint-col-power-type` }),
                            s(`col`, { className: `datapoint-col-state` }),
                            s(`col`, { className: `datapoint-col-required` }),
                          ],
                        }),
                        s(j, {
                          children: b(C, {
                            children: [
                              s(x, { children: U(`value`) }),
                              s(x, { children: U(`type`) }),
                              s(x, { children: U(`unit`) }),
                              s(x, { children: `AC/DC` }),
                              s(x, { children: `ioBroker State-Path` }),
                              s(x, { children: U(`required`) }),
                            ],
                          }),
                        }),
                        s(E, {
                            ...
                            b(
                              a.Fragment,
                              {
                                children: [
                                  e.showTitle
                                    ? s(C, {
                                        className: `datapoint-section-row`,
                                        children: s(x, {
                                          colSpan: 6,
                                          children: e.title,
                                        }),
                                    ...
                                    : null,
                                  e.rows.map(({ assignment: e, index: t }) =>
                                    s(
                                      Le,
                                      {
                                        assignment: e,
    ...
    : s(Be, { text: U(`noDatapointAssignments`) });
}
function Le({
  assignment: e,
  index: t,
  ...
  return b(C, {
    children: [
      b(x, {
        children: [
          b(p, {
            ...
            gap: 0.5,
            children: [
              s(A, { variant: `body2`, children: Ve(e) }),
              s(ze, { id: `${e.mappingKey || e.key}-${t}`, text: He(e) }),
            ],
          }),
          s(A, {
            variant: `caption`,
      ...
      s(x, { children: Ue(e) }),
      s(x, { children: Xe(e, t, r) }),
      s(x, { children: Qe(e, t, r) }),
      b(x, {
        children: [
          s(v, {
            value: e.stateId || ``,
            onChange: (e) => r(t, { stateId: e.target.value }),
            size: `small`,
            fullWidth: !0,
            autoComplete: `off`,
            inputProps: {
          ...
          nt(e.stateId)
            ? s(m, {
                ...
                severity: `error`,
                children: U(`customScriptStatePathWarning`),
              })
            : null,
          Y(e) ? s(Re, { assignment: e, index: t, updateAssignment: r }) : null,
        ],
      }),
      s(x, {
        children: e.required
          ? s(D, { color: `primary`, size: `small`, label: U(`required`) })
          : null,
      }),
    ],
  });
}
function Re({ assignment: e, index: t, updateAssignment: n }) {
  let r = e.controlValues || {};
  function i(e, i) {
    n(t, { controlValues: { ...r, [e]: i } });
  }
  return b(y, {
    className: `control-value-grid`,
    children: [
      s(v, {
        label: U(`batteryControlGridChargeValue`),
        size: `small`,
        value: r.gridCharge || ``,
        onChange: (e) => i(`gridCharge`, e.target.value),
        fullWidth: !0,
      }),
      s(v, {
        label: U(`batteryControlPvValue`),
        size: `small`,
        value: r.pv || ``,
        onChange: (e) => i(`pv`, e.target.value),
        fullWidth: !0,
      }),
      s(v, {
        label: U(`batteryControlHoldValue`),
        size: `small`,
        value: r.hold || ``,
        onChange: (e) => i(`hold`, e.target.value),
        fullWidth: !0,
      }),
    ],
  });
}
function ze({ id: r, text: i }) {
  let [a, o] = n(!1),
    l = t(null);
  if (
    (e(
  ...
  function u() {
    (l.current && window.clearTimeout(l.current),
      (l.current = window.setTimeout(() => o(!1), he)));
  }
  function d(e) {
    (e.preventDefault(),
      e.stopPropagation(),
  ...
  return s(c, {
    ...
    children: s(h, {
      ...
      onTouchEnd: d,
      size: `small`,
      children: s(w, { className: `datapoint-info-icon` }),
    }),
  });
}
function Be({ text: e }) {
  return s(f, {
    ...
    elevation: 0,
    children: s(A, { color: `text.secondary`, children: e }),
  });
}
function Ve(e = {}) {
  let t = String(e.key || ``);
...
function Y(e = {}) {
  return String(e.key || ``) === `batteryControlMode`;
}
function Ue(e = {}) {
    ...
    if (!t.has(e)) {
      ...
      (r || (n += 1),
        t.set(e, {
          ...
          subtitle: We(i.scopeName || (r ? `Household` : `Plant`)),
...
function Je(e) {
  return e.rows.some(
    ({ assignment: e }) =>
      e.required === !0 && String(e.stateId || ``).trim().length === 0,
  );
}
function Ye(e) {
  let t = e.rows.filter(({ assignment: e }) => Y(e));
  if (!t.length)
    return [{ key: `all`, title: ``, showTitle: !1, rows: e.rows }];
  let n = e.rows.filter(({ assignment: e }) => !Y(e));
  return [
    {
      key: `telemetry`,
      title: U(`telemetryDataSend`),
      showTitle: n.length > 0,
      rows: n,
    },
    {
      key: `battery-control`,
      title: U(`ioBrokerBatteryControl`),
      showTitle: !0,
      rows: t,
    },
...
function Xe(e, t, n) {
  return Y(e)
    ? Ze(e, t, n)
    : String(e.stateId || ``).trim()
      ? e.unit === `W`
        ? s(D, { size: `small`, label: e.sourceUnit === `kW` ? `kW` : `W` })
        : e.unit === `Wh`
          ? s(D, {
              size: `small`,
              label: e.sourceUnit === `kWh` ? `kWh` : `Wh`,
            })
          : s(D, { size: `small`, label: e.unit || `-` })
      : s(D, { size: `small`, label: `-` });
}
function Ze(e, t, n) {
  return b(v, {
    label: U(`gridChargingPermission`),
    select: !0,
    size: `small`,
    value: e.gridChargingAllowed === !1 ? `deny` : `allow`,
    onChange: (e) => n(t, { gridChargingAllowed: e.target.value === `allow` }),
    fullWidth: !0,
    children: [
      s(d, { value: `allow`, children: U(`allow`) }),
      s(d, { value: `deny`, children: U(`deny`) }),
    ],
  });
}
function Qe(e, t, n) {
  let r = et(e),
    i = r || $e(e.powerType) || `AC`;
  return r
    ? s(D, { size: `small`, label: i })
    : e.unit === `W`
      ? b(v, {
          select: !0,
          size: `small`,
          ...
          fullWidth: !0,
          children: [
            s(d, { value: `AC`, children: `AC` }),
            s(d, { value: `DC`, children: `DC` }),
          ],
        })
      : null;
}
...
async function st() {
  try {
    var e;
    let t = new URL(we.href);
    t.searchParams.set(`_`, String(Date.now()));
    let n = await fetch(t.href, { cache: `no-store` });
    if (!n.ok) return ``;
    let r = await n.json(),
      i = Array.isArray(r == null ? void 0 : r.exposes)
        ? r.exposes.find((e) => (e == null ? void 0 : e.name) === `Components`)
        : null;
    return Ee(
      i == null ||
        (e = i.assets) == null ||
        ...
        (e = e.sync) == null
        ? void 0
        : e.find((e) => /(^|\/)main-[^/]+\.js$/u.test(String(e || ``))),
    );
  } catch {
    return ``;
  }
...
async function ct() {
  ...
  (e.searchParams.set(`aemReload`, String(Date.now())),
  ...
  if (`caches` in window)
    try {
      ...
      await Promise.all(
        e
          .filter((e) =>
            /ai-energy-manager|ConfigCustomAiEnergyManager|iobroker/i.test(e),
          )
...
function ut(e) {
  if (!e) return `-`;
  let t = new Date(e);
  return Number.isNaN(t.getTime()) ? String(e) : t.toLocaleString(ft());
}
function dt(e) {
  if (!e) return `-`;
  let t = new Date(e);
...
function Z(e) {
  ...
  return Number.isNaN(t.getTime())
    ? String(e)
    : t.toLocaleTimeString(ft(), { hour: `2-digit`, minute: `2-digit` });
}
function ft() {
...
function ht(e) {
  return mt(e.operatingMode || e.action);
}
...
var _t = class extends a.Component {
  ...
  vt = { AemConfig: _t };
window.aemStandaloneConfig &&
  M(document.getElementById(`root`)).render(s(ke, {}));
export { _t as AemConfig, vt as default };
