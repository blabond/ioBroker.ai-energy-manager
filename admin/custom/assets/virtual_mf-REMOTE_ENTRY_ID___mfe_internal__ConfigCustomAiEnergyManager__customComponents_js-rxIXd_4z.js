  ...
  return (
    (u ||= m(() =>
      e(
        () =>
          import(
            `./_virtual_mf-localSharedImportMap___mfe_internal__ConfigCustomAiEnergyManager-BlA7L2Q4.js`
          ),
        [],
        import.meta.url,
      ),
...
async function g() {
  return (
    (d ||= m(() =>
      e(() => import(`./virtualExposes-C9LIInO1.js`), [], import.meta.url),
    )
      .then((e) => e.default ?? e)
      .catch((e) => {
        throw ((d = void 0), e);
...
async function _(n = {}, r = []) {
  ...
  if (o.share[`react-dom`] === void 0) {
    let t = await e(
        () =>
          import(
            `./_virtual_mf___mfe_internal__ConfigCustomAiEnergyManager__loadShare___mf_0_iobroker_mf_1_adapter_mf_2_react_mf_2_v5__loadShare__.mjs-DbPfsCnh.js`
          ).then((e) => (e.H(), e.V)),
        [],
        import.meta.url,
      ),
